...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/chat/:chat_id/users", rt.addToGroup)
	rt.router.DELETE("/chat/:chat_id/users/:user_id", rt.leaveGroup)
	...
	rt.router.GET("/message/:message_id", rt.retrieveMessage)
